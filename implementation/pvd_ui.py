...
class PVDSteganographyGUI:
    ...
    def build_ui(self, root):
        ...
        # EDIT(1) START
        # img_in = self.image_placeholder(col_a, text="Input Cover Image")
        # img_in.pack(padx=10, pady=(0, 4))

        # self.cover_image_label = tk.Label(
        #     col_a,
        #     text="Input Cover Image",
        #     font=("Arial", 12),
        #     fg='gray',
        #     bg='white',
        #     # width=20,
        #     # height=8
        # )
        # self.cover_image_label.pack(padx=10, pady=(0, 4))
        # EDIT(1) END
        ...
        # # Embedding content frame
        # embed_content_frame = tk.Frame(embed_frame, bg='#e8e8e8')
        # embed_content_frame.pack(fill=tk.BOTH, expand=True, padx=10, pady=(0, 10))

        # # Left side - Cover Image
        # cover_frame = tk.Frame(embed_content_frame, bg='#e8e8e8')
        # cover_frame.pack(side=tk.LEFT, fill=tk.BOTH, expand=True, padx=(0, 10))
        
        # self.cover_image_frame = tk.Frame(cover_frame, bg='white', relief=tk.SUNKEN, bd=2)
        # self.cover_image_frame.pack(fill=tk.BOTH, expand=True, pady=(0, 5))
        
        # self.cover_image_label = tk.Label(
        #     self.cover_image_frame,
        #     text="Input Cover Image",
        #     font=("Arial", 12),
        #     fg='gray',
        #     bg='white'
        # )
        # self.cover_image_label.pack(expand=True)
        ...
        #     bg='white'
        # )
        # self.secret_text_area.pack(fill=tk.BOTH, expand=True, pady=(0, 5))
        # self.secret_text_area.insert("1.0", "This is another Secret Message")
        ...
        # self.secret_text_area = tk.Text(txt_frame, height=8, wrap="word", borderwidth=0, highlightthickness=0, font=("Segoe UI", 10))
        # self.secret_text_area.insert("1.0", "This is another Secret Message")
        # self.secret_text_area.pack(fill="both", expand=True, padx=4, pady=4)
        ...
        img_out = self.image_placeholder(col_c, text="Output Embed Image")
        ...
        img_embedded = self.image_placeholder(col1, text="Embedded Image")
